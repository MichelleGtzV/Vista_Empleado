...
//donde guardaremos los nueos valores
    ...
    // Mostrar mensaje de agregado
        Swal.fire({
            icon: 'success',
            title: 'Agregado',
            text: 'Se ha agregado el combo'
        });
    loadTablaCombos();
}

export function loadTablaCombos() {
    let cuerpo = "";
    combos.forEach(function (combo) {
        let registro =
                ...
                '<td>' + combo.precio + '</td>' +
                '<td><img src="' + combo.foto + '" alt="Foto del Combo" style="width:150px; height:80px;"></td></tr>';
        cuerpo += registro;
    });
    console.log(cuerpo);
...
//    dentro de combos el index actual y le instroducimos el nuevo combo 
    ...
    // Mostrar mensaje de agregado
        Swal.fire({
            icon: 'success',
            title: 'Actualizado',
            text: 'Se ha actualizado el combo'
        });
    loadTablaCombos();
}
